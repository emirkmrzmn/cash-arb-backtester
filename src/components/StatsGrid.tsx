    ...
    <div className="rounded-lg p-3 border bg-white/[0.02] border-white/[0.04] col-span-2">
      ...
      <div className="flex gap-4">
        <div className="flex items-baseline gap-1.5">
          <span className="text-[10px] text-emerald-400/70 font-semibold">E1</span>
          <span className="text-lg font-bold font-mono text-white/80">{e1}</span>
        </div>
        <div className="flex items-baseline gap-1.5">
          <span className="text-[10px] text-blue-400/70 font-semibold">E2</span>
          <span className="text-lg font-bold font-mono text-white/80">{e2 !== null ? e2 : <span className="text-white/20">—</span>}</span>
        </div>
        <div className="flex items-baseline gap-1.5">
          <span className="text-[10px] text-amber-400/70 font-semibold">E3</span>
          <span className="text-lg font-bold font-mono text-white/80">{e3 !== null ? e3 : <span className="text-white/20">—</span>}</span>
        </div>
      </div>
    </div>
  );
